            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <input type="text" name="cf_captcha_site_key" value="<?php echo get_sanitize_input($config['cf_captcha_site_key']); ?>" id="cf_captcha_site_key" class="frm_input" size="52"> <a href="https://www.cloudflare.com/ko-kr/products/turnstile/" target="_blank" class="btn_frmline">CloudFlare CAPTCHA 등록하기</a>
                        </td>
                    </tr>
                    <tr>
